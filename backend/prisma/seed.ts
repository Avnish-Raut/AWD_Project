...
async function main() {
  ...
  console.log('Admin: admin@smartevents.edu / password123');
  console.log('Org:   tech@smartevents.edu / password123');
  console.log('User:  student1@smartevents.edu / password123');
  console.log('----------------------------------------------------');
}
